...
const reactVChartDir = path.dirname(
  require.resolve('@visactor/react-vchart/package.json'),
)
const vchartVisactorModulesDir = path.resolve(
  vchartDir,
  'node_modules/@visactor',
)
  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        '@visactor/vdataset': path.resolve(
          vchartVisactorModulesDir,
          'vdataset',
        ),
        '@visactor/vscale': path.resolve(vchartVisactorModulesDir, 'vscale'),
        '@visactor/vutils': path.resolve(vchartVisactorModulesDir, 'vutils'),
